...
export default function Nabvar() {
    return(
        <div className="">
            <nav className=" fixed w-full z-20 top-0 start-0 border-b border-gray-800 bg-gray-300 backdrop-blur-md rounded-full mt-1 ">
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
             <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 text-black  ">
